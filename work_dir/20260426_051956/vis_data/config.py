...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False, interval=10, save_best='mDice', type='CheckpointHook'),
...
param_scheduler = [
    ...
    dict(by_epoch=True, power=0.9, type='PolyLR'),
]
resume = False
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            dict(degree=10, prob=0.5, type='RandomRotate'),
            dict(prob=0.5, type='RandomFlip'),
            dict(type='PackSegInputs'),
        ],
        type='mmseg.datasets.basesegdataset.BaseSegDataset'),
    num_workers=4)
train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(reduce_zero_label=False, type='LoadAnnotations'),
...
vis_backends = [
    ...
    dict(save_dir='vis_data', type='TensorboardVisBackend'),
]
visualizer = dict(
    name='visualizer',
